...
<body>
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head">
           <h1>نظام إدارة المخزون - تقرير المبيعات</h1>
           <strong><?php if(isset($start_date)){ echo $start_date;}?> حتى تاريخ <?php if(isset($end_date)){echo $end_date;}?> </strong>
       </div>
      <table class="table table-border">
        ...
        <tfoot>
         <tr class="text-right">
           <td colspan="4"></td>
           <td colspan="1">المبلغ الإجمالي</td>
           <td> $
  ...
  <?php
        ...
        $session->msg("d", "عذرا لم يتم العثور على مبيعات. ");
        redirect('sales_report.php', false);
     endif;
  ?>
</body>
